...
func main() { // Entry point to the project
	...
	http.ListenAndServe("localhost:9000", r) // Listen to port and put it to r.
}

func getSession() *mgo.Session {
	s, err := mgo.Dial("mongodb://localhost:27017") // This is to connect with mongodb on port 27107
